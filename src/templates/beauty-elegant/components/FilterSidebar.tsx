...
// Beauty Elegant Template — Filter Sidebar
// Desktop: sticky left sidebar with collapsible filter groups.
// Mobile: bottom drawer overlay with slideUp animation.
// Visual only — handlers come as props.
// ZERO hardcoded colors — all via var(--t-*).

import { useState } from "react";
import { X, SlidersHorizontal } from "lucide-react";
import type { BeautyElegantFilterGroup } from "../types";
        ...
        >
          ...
          <div
            style={{
              ...
              maxHeight: "85vh",
              overflowY: "auto",
              animation: "beautySlideUp 200ms ease",
            }}
            role="dialog"
            aria-modal="true"
            aria-label="Filtros de productos"
