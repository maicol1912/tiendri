...
// Furniture Dark Template — Cart Context
// localStorage key: tc_furniture_dark_cart_{slug}
// Pattern: same isFirstPersistRun guard used across all templates.
...
function cartKey(slug: string): string {
  return `tc_furniture_dark_cart_${slug}`;
}
...
export function useCart(): CartContextValue {
  ...
  if (!ctx) {
    throw new Error("useCart must be used inside CartProvider (furniture-dark)");
  }
  return ctx;
}
