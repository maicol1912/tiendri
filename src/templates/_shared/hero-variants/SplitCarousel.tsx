// Shared — SplitCarousel Hero (from beauty-soft)
// Rounded card: left text block (35%) + right image (65%) via flexbox.
// Carousel dots shown in image column. ZERO hardcoded colors — all via var(--t-*).
