...
// Pets Classic Template — Navigation Hook
// Centralizes all navigation — components never construct URL strings manually.
...
export const TEMPLATE_BASE = "/template/pets-classic";
