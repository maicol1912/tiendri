// Tech Premium Template — Footer
// Figma: black bg (#000000), white text. Desktop: 3-col (logo+text, Services, Assistance).
// Social icons: Twitter, Facebook, TikTok, Instagram.
          ...
          <div className="flex flex-col sm:flex-row gap-10 lg:gap-16 text-center lg:text-left">
            ...
            <nav aria-label="Servicios">
              ...
              <ul className="flex flex-col gap-2 list-none m-0 p-0">
                {services.map((item) => (
                  <li key={item}>
                    <span className="text-[var(--t-text-footer)] text-sm font-normal leading-8 cursor-pointer hover:text-white transition-colors">
                      {item}
                    </span>
                  </li>
                ))}
