...
// Decor Warm Template — Cart Context
// Manages cart state in localStorage.
// Key: tc_decor_warm_cart_{slug}
...
function cartKey(slug: string): string {
  return `tc_decor_warm_cart_${slug}`;
}
...
export function CartProvider({ children, slug }: CartProviderProps) {
  ...
  // Persist on every items change — skip the initial empty render
