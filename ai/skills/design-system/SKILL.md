...
Paleta: **negro + gris + rojo + blanco**. Dashboard = light (fondo blanco, texto negro, accent rojo). Landing/marketing = dark (fondo negro, texto blanco, accent rojo).

> Nota: Los nombres de las CSS vars `--ember-blue-*` se mantienen por retrocompatibilidad con `globals.css`, pero los valores que usan las páginas de marketing y auth son rojo — no azul. El landing y auth sobreescriben estas variables con los valores rojos listados abajo.
...
| `--ember-blue-600` | `#B91C1C` | CTAs, main accent — PRIMARY (rojo) |
| `--ember-blue-500` | `#DC2626` | Hover, active states (rojo hover) |
| `--ember-blue-800` | `#991B1B` | Deep red, pressed states |
| `--ember-blue-400` | `#F87171` | Links, light highlights (rojo claro) |
| `--ember-blue-950` | `#2A0A0A` | Badge backgrounds, subtle tints (rojo oscuro) |
