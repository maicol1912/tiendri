# Reading List — Documentación por agente

> Leer ANTES de cualquier tarea. No se empieza a trabajar sin haber leído lo que corresponde.

---

## TIER 0 — TODOS LOS AGENTES

Lectura obligatoria para CUALQUIER agente, sin excepción:

| Doc | Qué contiene |
|-----|--------------|
| `ai/rules/tiendri-rules.md` | Reglas de negocio, convenciones de código, errores, seguridad, branding |
| `ai/rules/shared-agent-rules.md` | Checklist pre-tarea, regla de entrega, estándares de calidad, colaboración |
...
| Doc | Para qué |
|-----|----------|
| `docs/technical.md` | Arquitectura, modelo de datos, RLS, auth |

---

## REFERENCIA RÁPIDA — Docs del proyecto
